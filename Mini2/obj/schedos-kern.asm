...
multiboot_start:
  ...
  100013:	9d                   	popf   
	call start
  100014:	e8 75 02 00 00       	call   10028e <start>
  100019:	90                   	nop
...
00100060 <_generic_int_handler>:
  ...
  10006c:	54                   	push   %esp
	call interrupt
  10006d:	e8 7c 01 00 00       	call   1001ee <interrupt>
...
void priority(int p)
{
  ...
  10009c:	a1 50 78 10 00       	mov    0x107850,%eax
...
void share(int s)
{
  ...
  1000a9:	a1 50 78 10 00       	mov    0x107850,%eax
	current->p_share	 = s;
...
schedule(void)
{
  ...
  1000bd:	a1 50 78 10 00       	mov    0x107850,%eax
 *
 *****************************************************************************/
...
schedule(void)
{
  ...
  1000c4:	53                   	push   %ebx
	pid_t pid = current->p_pid;
  1000c5:	8b 10                	mov    (%eax),%edx
	uint32_t priority = current->p_priority;
	
	if (scheduling_algorithm == 0)
  1000c7:	a1 54 78 10 00       	mov    0x107854,%eax
  1000cc:	85 c0                	test   %eax,%eax
  1000ce:	75 1c                	jne    1000ec <schedule+0x2f>
		while (1) {
			pid = (pid + 1) % NPROCS;
  1000d0:	b9 05 00 00 00       	mov    $0x5,%ecx
  1000d5:	8d 42 01             	lea    0x1(%edx),%eax
  1000d8:	99                   	cltd   
  1000d9:	f7 f9                	idiv   %ecx
  ...
  1000de:	83 b8 70 6e 10 00 01 	cmpl   $0x1,0x106e70(%eax)
  1000e5:	75 ee                	jne    1000d5 <schedule+0x18>
  1000e7:	e9 cb 00 00 00       	jmp    1001b7 <schedule+0xfa>
				run(&proc_array[pid]);
		}
	
	else if(scheduling_algorithm == 1)
  1000ec:	83 f8 01             	cmp    $0x1,%eax
  1000ef:	75 37                	jne    100128 <schedule+0x6b>
  1000f1:	ba 01 00 00 00       	mov    $0x1,%edx
		while(1) {
			for(pid = 1; pid < NPROCS; pid++) {
				if (proc_array[pid].p_state == P_RUNNABLE)
  1000f6:	6b c8 5c             	imul   $0x5c,%eax,%ecx
  1000f9:	83 b9 70 6e 10 00 01 	cmpl   $0x1,0x106e70(%ecx)
  100100:	75 12                	jne    100114 <schedule+0x57>
				{
					run(&proc_array[pid]);
  100102:	6b d2 5c             	imul   $0x5c,%edx,%edx
  100105:	83 ec 0c             	sub    $0xc,%esp
  100108:	81 c2 1c 6e 10 00    	add    $0x106e1c,%edx
  10010e:	52                   	push   %edx
  10010f:	e8 a9 04 00 00       	call   1005bd <run>
				run(&proc_array[pid]);
		}
  ...
  100118:	89 c2                	mov    %eax,%edx
		while(1) {
			for(pid = 1; pid < NPROCS; pid++) {
  10011a:	7e da                	jle    1000f6 <schedule+0x39>
  10011c:	ba 01 00 00 00       	mov    $0x1,%edx
  100121:	b8 01 00 00 00       	mov    $0x1,%eax
  100126:	eb ce                	jmp    1000f6 <schedule+0x39>
					run(&proc_array[pid]);
				}
			}
		}
  ...
  10012b:	75 53                	jne    100180 <schedule+0xc3>
		while(1) {
			pid = (pid + 1) % NPROCS;
  10012d:	b9 05 00 00 00       	mov    $0x5,%ecx
  100132:	8d 42 01             	lea    0x1(%edx),%eax
  100135:	be 05 00 00 00       	mov    $0x5,%esi
  10013a:	99                   	cltd   
  10013b:	f7 f9                	idiv   %ecx
  10013d:	31 c0                	xor    %eax,%eax
  10013f:	89 d3                	mov    %edx,%ebx
			priority = NPROCS;
			int i;
			for(i = 0; i < NPROCS; i++) {
				if (proc_array[i].p_state == P_RUNNABLE &&
  100141:	83 b8 70 6e 10 00 01 	cmpl   $0x1,0x106e70(%eax)
  100148:	75 0c                	jne    100156 <schedule+0x99>
  10014a:	8b b8 20 6e 10 00    	mov    0x106e20(%eax),%edi
  100150:	39 fe                	cmp    %edi,%esi
  100152:	76 02                	jbe    100156 <schedule+0x99>
  100154:	89 fe                	mov    %edi,%esi
  100156:	83 c0 5c             	add    $0x5c,%eax
	else if(scheduling_algorithm == 2)
		while(1) {
			pid = (pid + 1) % NPROCS;
			priority = NPROCS;
			int i;
			for(i = 0; i < NPROCS; i++) {
  100159:	3d cc 01 00 00       	cmp    $0x1cc,%eax
  10015e:	75 e1                	jne    100141 <schedule+0x84>
				if (proc_array[i].p_state == P_RUNNABLE &&
			...
			if (proc_array[pid].p_state == P_RUNNABLE &&
  100160:	6b db 5c             	imul   $0x5c,%ebx,%ebx
  100163:	83 bb 70 6e 10 00 01 	cmpl   $0x1,0x106e70(%ebx)
  10016a:	75 c6                	jne    100132 <schedule+0x75>
  10016c:	39 b3 20 6e 10 00    	cmp    %esi,0x106e20(%ebx)
  100172:	75 be                	jne    100132 <schedule+0x75>
				proc_array[pid].p_priority == priority)
			{
				run(&proc_array[pid]);
  100174:	83 ec 0c             	sub    $0xc,%esp
  100177:	81 c3 1c 6e 10 00    	add    $0x106e1c,%ebx
  10017d:	53                   	push   %ebx
  10017e:	eb 8f                	jmp    10010f <schedule+0x52>
			}
		}
		
	else if(scheduling_algorithm == 3)
  100180:	83 f8 03             	cmp    $0x3,%eax
  100183:	75 48                	jne    1001cd <schedule+0x110>
			...
			pid = (pid + 1) % NPROCS;
  100185:	b9 05 00 00 00       	mov    $0x5,%ecx
			}
		}
		...
		while(1) {
			if( proc_array[pid].p_state == P_RUNNABLE &&
  10018a:	6b c2 5c             	imul   $0x5c,%edx,%eax
  10018d:	83 b8 70 6e 10 00 01 	cmpl   $0x1,0x106e70(%eax)
  100194:	75 2f                	jne    1001c5 <schedule+0x108>
				proc_array[pid].p_times_run >= proc_array[pid].p_share)
  100196:	8b 98 28 6e 10 00    	mov    0x106e28(%eax),%ebx
			}
		}
		...
		while(1) {
			if( proc_array[pid].p_state == P_RUNNABLE &&
  10019c:	3b 98 24 6e 10 00    	cmp    0x106e24(%eax),%ebx
  1001a2:	72 0c                	jb     1001b0 <schedule+0xf3>
				proc_array[pid].p_times_run >= proc_array[pid].p_share)
				proc_array[pid].p_times_run = 0;
  1001a4:	c7 80 28 6e 10 00 00 	movl   $0x0,0x106e28(%eax)
  1001ab:	00 00 00 
			}
		}
		...
		while(1) {
			if( proc_array[pid].p_state == P_RUNNABLE &&
  1001ae:	eb 15                	jmp    1001c5 <schedule+0x108>
				proc_array[pid].p_times_run = 0;
				...
				proc_array[pid].p_times_run < proc_array[pid].p_share)
			{
				proc_array[pid].p_times_run++;
  1001b0:	43                   	inc    %ebx
  1001b1:	89 98 28 6e 10 00    	mov    %ebx,0x106e28(%eax)
				run(&proc_array[pid]);
  1001b7:	83 ec 0c             	sub    $0xc,%esp
  1001ba:	05 1c 6e 10 00       	add    $0x106e1c,%eax
  1001bf:	50                   	push   %eax
  1001c0:	e9 4a ff ff ff       	jmp    10010f <schedule+0x52>
			}
			pid = (pid + 1) % NPROCS;
  1001c5:	8d 42 01             	lea    0x1(%edx),%eax
  1001c8:	99                   	cltd   
  1001c9:	f7 f9                	idiv   %ecx
		}
  1001cb:	eb bd                	jmp    10018a <schedule+0xcd>
	// If we get here, we are running an unknown scheduling algorithm.
	cursorpos = console_printf(cursorpos, 0x100, "\nUnknown scheduling algorithm %d\n", scheduling_algorithm);
  1001cd:	8b 15 00 80 19 00    	mov    0x198000,%edx
  1001d3:	50                   	push   %eax
  1001d4:	68 7c 0b 10 00       	push   $0x100b7c
  1001d9:	68 00 01 00 00       	push   $0x100
  1001de:	52                   	push   %edx
  1001df:	e8 7e 09 00 00       	call   100b62 <console_printf>
  1001e4:	83 c4 10             	add    $0x10,%esp
  1001e7:	a3 00 80 19 00       	mov    %eax,0x198000
  1001ec:	eb fe                	jmp    1001ec <schedule+0x12f>
...
interrupt(registers_t *reg)
{
  ...
  1001ef:	a1 50 78 10 00       	mov    0x107850,%eax
  1001f4:	b9 11 00 00 00       	mov    $0x11,%ecx
 *
 *****************************************************************************/
...
interrupt(registers_t *reg)
{
  1001f9:	56                   	push   %esi
  1001fa:	53                   	push   %ebx
  1001fb:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	// Save the current process's register state
	// into its process descriptor
	current->p_registers = *reg;
  1001ff:	8d 78 10             	lea    0x10(%eax),%edi
  100202:	89 de                	mov    %ebx,%esi
  100204:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

	switch (reg->reg_intno) {
  100206:	8b 53 28             	mov    0x28(%ebx),%edx
  100209:	83 fa 32             	cmp    $0x32,%edx
  10020c:	74 38                	je     100246 <interrupt+0x58>
  10020e:	77 0e                	ja     10021e <interrupt+0x30>
  100210:	83 fa 30             	cmp    $0x30,%edx
  100213:	74 15                	je     10022a <interrupt+0x3c>
  100215:	77 18                	ja     10022f <interrupt+0x41>
  100217:	83 fa 20             	cmp    $0x20,%edx
  10021a:	74 4d                	je     100269 <interrupt+0x7b>
  10021c:	eb 6e                	jmp    10028c <interrupt+0x9e>
  10021e:	83 fa 33             	cmp    $0x33,%edx
  100221:	74 30                	je     100253 <interrupt+0x65>
  100223:	83 fa 34             	cmp    $0x34,%edx
  100226:	74 46                	je     10026e <interrupt+0x80>
  100228:	eb 62                	jmp    10028c <interrupt+0x9e>

	case INT_SYS_YIELD:
		// The 'sys_yield' system call asks the kernel to schedule
		// the next process.
		schedule();
  10022a:	e8 8e fe ff ff       	call   1000bd <schedule>
  ...
  10022f:	a1 50 78 10 00       	mov    0x107850,%eax
		current->p_exit_status = reg->reg_eax;
  100234:	8b 53 1c             	mov    0x1c(%ebx),%edx
		// The application stored its exit status in the %eax register
		// before calling the system call.  The %eax register has
		// changed by now, but we can read the application's value
		// out of the 'reg' argument.
		// (This shows you how to transfer arguments to system calls!)
		current->p_state = P_ZOMBIE;
  100237:	c7 40 54 03 00 00 00 	movl   $0x3,0x54(%eax)
		current->p_exit_status = reg->reg_eax;
  10023e:	89 50 58             	mov    %edx,0x58(%eax)
		schedule();
  100241:	e8 77 fe ff ff       	call   1000bd <schedule>
// The preferred scheduling algorithm.
int scheduling_algorithm;
...
{
	current->p_priority = p;
  100246:	a1 50 78 10 00       	mov    0x107850,%eax
  10024b:	8b 53 1c             	mov    0x1c(%ebx),%edx
  10024e:	89 50 04             	mov    %edx,0x4(%eax)
  100251:	eb 0d                	jmp    100260 <interrupt+0x72>
	...
	case INT_SYS_USER2:
		share(reg->reg_eax);
  100253:	8b 53 1c             	mov    0x1c(%ebx),%edx
	current->p_priority = p;
}
...
{
	current->p_times_run = 0;
  100256:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
	current->p_share	 = s;
  10025d:	89 50 08             	mov    %edx,0x8(%eax)
		priority(reg->reg_eax);
		run(current);
  ...
  100263:	50                   	push   %eax
  100264:	e8 54 03 00 00       	call   1005bd <run>
	...
	case INT_CLOCK:
		...
		schedule();
  100269:	e8 4f fe ff ff       	call   1000bd <schedule>

	case INT_SYS_PRINTCHAR:
		*cursorpos++ = (uint16_t) reg->reg_eax; //Where we stored it
  10026e:	a1 00 80 19 00       	mov    0x198000,%eax
		run(current);
  100273:	83 ec 0c             	sub    $0xc,%esp
	...
	case INT_SYS_PRINTCHAR:
		*cursorpos++ = (uint16_t) reg->reg_eax; //Where we stored it
  100276:	8b 53 1c             	mov    0x1c(%ebx),%edx
  100279:	66 89 10             	mov    %dx,(%eax)
  10027c:	83 c0 02             	add    $0x2,%eax
  10027f:	a3 00 80 19 00       	mov    %eax,0x198000
		run(current);
  100284:	ff 35 50 78 10 00    	pushl  0x107850
  10028a:	eb d8                	jmp    100264 <interrupt+0x76>
  10028c:	eb fe                	jmp    10028c <interrupt+0x9e>
...
start(void)
{
  ...
  10028f:	bf 00 00 30 00       	mov    $0x300000,%edi
 *
 *****************************************************************************/
...
start(void)
{
  100294:	56                   	push   %esi
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  100295:	be 01 00 00 00       	mov    $0x1,%esi
 *
 *****************************************************************************/
...
start(void)
{
  10029a:	53                   	push   %ebx
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  10029b:	bb 7c 6e 10 00       	mov    $0x106e7c,%ebx
start(void)
{
	int i;
	...
	segments_init();
  1002a0:	e8 f7 00 00 00       	call   10039c <segments_init>
	interrupt_controller_init(1);
  1002a5:	83 ec 0c             	sub    $0xc,%esp
  1002a8:	6a 01                	push   $0x1
  1002aa:	e8 e8 01 00 00       	call   100497 <interrupt_controller_init>
	console_clear();
  1002af:	e8 6c 02 00 00       	call   100520 <console_clear>
  ...
  1002be:	68 1c 6e 10 00       	push   $0x106e1c
  1002c3:	e8 38 04 00 00       	call   100700 <memset>
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  1002c8:	83 c4 10             	add    $0x10,%esp
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1002cb:	c7 05 1c 6e 10 00 00 	movl   $0x0,0x106e1c
  1002d2:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  1002d5:	c7 05 70 6e 10 00 00 	movl   $0x0,0x106e70
  1002dc:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1002df:	c7 05 78 6e 10 00 01 	movl   $0x1,0x106e78
  1002e6:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  1002e9:	c7 05 cc 6e 10 00 00 	movl   $0x0,0x106ecc
  1002f0:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1002f3:	c7 05 d4 6e 10 00 02 	movl   $0x2,0x106ed4
  1002fa:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  1002fd:	c7 05 28 6f 10 00 00 	movl   $0x0,0x106f28
  100304:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100307:	c7 05 30 6f 10 00 03 	movl   $0x3,0x106f30
  10030e:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100311:	c7 05 84 6f 10 00 00 	movl   $0x0,0x106f84
  100318:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10031b:	c7 05 8c 6f 10 00 04 	movl   $0x4,0x106f8c
  100322:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100325:	c7 05 e0 6f 10 00 00 	movl   $0x0,0x106fe0
  10032c:	00 00 00 
  10032f:	8d 43 fc             	lea    -0x4(%ebx),%eax
	for (i = 1; i < NPROCS; i++) {
  ...
  100335:	50                   	push   %eax
  100336:	e8 99 02 00 00       	call   1005d4 <special_registers_init>

		// Initialize priority
		proc_array[i].p_priority = i%2;
  10033b:	89 f0                	mov    %esi,%eax
  10033d:	83 e0 01             	and    $0x1,%eax
  100340:	89 03                	mov    %eax,(%ebx)

		// Initialize share
		proc_array[i].p_times_run = 0;
		proc_array[i].p_share = i%2 + 1;
  100342:	40                   	inc    %eax
  100343:	89 43 04             	mov    %eax,0x4(%ebx)
  ...
  100346:	58                   	pop    %eax
  100347:	5a                   	pop    %edx
  100348:	8d 43 3c             	lea    0x3c(%ebx),%eax
		// Initialize share
		proc_array[i].p_times_run = 0;
		proc_array[i].p_share = i%2 + 1;
		...
		// Set ESP
		proc->p_registers.reg_esp = stack_ptr;
  10034b:	89 7b 48             	mov    %edi,0x48(%ebx)
	...
	for (i = 1; i < NPROCS; i++) {
  10034e:	81 c7 00 00 10 00    	add    $0x100000,%edi
		...
		program_loader(i - 1, &proc->p_registers.reg_eip);
  100354:	50                   	push   %eax
  100355:	8d 46 ff             	lea    -0x1(%esi),%eax
  ...
  100359:	50                   	push   %eax
		...
		// Initialize share
		proc_array[i].p_times_run = 0;
  10035a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
		...
		// Load process and set EIP, based on ELF image
		program_loader(i - 1, &proc->p_registers.reg_eip);
  100361:	e8 aa 02 00 00       	call   100610 <program_loader>
  ...
  100369:	c7 43 50 01 00 00 00 	movl   $0x1,0x50(%ebx)
  ...
  100373:	83 fe 05             	cmp    $0x5,%esi
  100376:	75 b7                	jne    10032f <start+0xa1>
  ...
  10037b:	68 78 6e 10 00       	push   $0x106e78
		proc->p_state = P_RUNNABLE;
	}
  ...
  100387:	80 0b 00 
	...
	// Initialize the scheduling algorithm.
	scheduling_algorithm = 0;
  10038a:	c7 05 54 78 10 00 00 	movl   $0x0,0x107854
  100391:	00 00 00 
...
segments_init(void)
{
  ...
  10039c:	b8 e8 6f 10 00       	mov    $0x106fe8,%eax
...
segments_init(void)
{
  ...
  1003bd:	88 15 3c 10 10 00    	mov    %dl,0x10103c
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  1003c3:	ba 50 70 10 00       	mov    $0x107050,%edx
segments_init(void)
{
	int i;
...
segments_init(void)
{
  ...
  1003e6:	c7 05 ec 6f 10 00 00 	movl   $0x180000,0x106fec
  1003ed:	00 18 00 
	kernel_task_descriptor.ts_ss0 = SEGSEL_KERN_DATA;
  1003f0:	66 c7 05 f0 6f 10 00 	movw   $0x10,0x106ff0
  1003f7:	10 00 
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  1003f9:	66 89 0c c5 50 70 10 	mov    %cx,0x107050(,%eax,8)
  100400:	00 
  ...
  10041f:	b8 1a 00 10 00       	mov    $0x10001a,%eax
	...
	for (i = INT_SYS_YIELD; i < INT_SYS_YIELD + 10; i++)
		SETGATE(interrupt_descriptors[i], 0,
  100424:	ba 50 70 10 00       	mov    $0x107050,%edx
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
			SEGSEL_KERN_CODE, default_int_handler, 0);
	...
	// The clock interrupt gets special handling
	SETGATE(interrupt_descriptors[INT_CLOCK], 0,
  100429:	66 a3 50 71 10 00    	mov    %ax,0x107150
  10042f:	c1 e8 10             	shr    $0x10,%eax
  100432:	66 a3 56 71 10 00    	mov    %ax,0x107156
  100438:	b8 30 00 00 00       	mov    $0x30,%eax
  10043d:	66 c7 05 52 71 10 00 	movw   $0x8,0x107152
  100444:	08 00 
  100446:	c6 05 54 71 10 00 00 	movb   $0x0,0x107154
  10044d:	c6 05 55 71 10 00 8e 	movb   $0x8e,0x107155
  ...
  100462:	66 89 0c c5 50 70 10 	mov    %cx,0x107050(,%eax,8)
  100469:	00 
...
outb(int port, uint8_t data)
{
  ...
  100512:	ee                   	out    %al,(%dx)
  100513:	b0 a9                	mov    $0xa9,%al
  100515:	b2 40                	mov    $0x40,%dl
  100517:	ee                   	out    %al,(%dx)
  100518:	b0 04                	mov    $0x4,%al
  10051a:	ee                   	out    %al,(%dx)
...
run(process_t *proc)
{
  1005bd:	8b 44 24 04          	mov    0x4(%esp),%eax
	current = proc;
  1005c1:	a3 50 78 10 00       	mov    %eax,0x107850

	asm volatile("movl %0,%%esp\n\t"
  1005c6:	83 c0 10             	add    $0x10,%eax
...
special_registers_init(process_t *proc)
{
  ...
  1005e0:	8d 43 10             	lea    0x10(%ebx),%eax
  1005e3:	50                   	push   %eax
  1005e4:	e8 17 01 00 00       	call   100700 <memset>
	proc->p_registers.reg_cs = SEGSEL_APP_CODE | 3;
  1005e9:	66 c7 43 44 1b 00    	movw   $0x1b,0x44(%ebx)
	proc->p_registers.reg_ds = SEGSEL_APP_DATA | 3;
  1005ef:	66 c7 43 34 23 00    	movw   $0x23,0x34(%ebx)
	proc->p_registers.reg_es = SEGSEL_APP_DATA | 3;
  1005f5:	66 c7 43 30 23 00    	movw   $0x23,0x30(%ebx)
	proc->p_registers.reg_ss = SEGSEL_APP_DATA | 3;
  1005fb:	66 c7 43 50 23 00    	movw   $0x23,0x50(%ebx)
	// Enable interrupts
	proc->p_registers.reg_eflags = EFLAGS_IF;
  100601:	c7 43 48 00 02 00 00 	movl   $0x200,0x48(%ebx)
}
